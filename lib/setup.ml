...
(* OASIS_START *)
(* DO NOT EDIT (digest: 95a2530e3ac2818666dc610921a022a3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Bruce Ricard <bruce.ricard@gmail.com>"];
          homepage = None;
          bugreports = None;
          synopsis = "A library to play tic tac toe.";
          description =
            Some [OASISText.Para "A library to play tic tac toe."];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("lwt.react", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["User"; "Users"; "Types"; "Pieces"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Ttt"; "Game"; "User"; "GameInProgress"; "Export"];
     ...
     oasis_digest = Some "\249Cqv7\001\004\221\bf \202\184\184\172q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
