...
(* OASIS_START *)
(* DO NOT EDIT (digest: 37fc1e69604b6d9060b7d41a8b8e3899) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["User"; "Users"; "Types"; "Pieces"; "GameInProgress"
                        ];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Ttt"; "Game"; "User"; "Export"];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "òQ\015\131í_ð«Ç\020\129f\002\127º\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
