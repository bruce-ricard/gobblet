...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1a8e41fc943b85d92ede0dabc8f6a40c) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$game_lib_tests", []))];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Reporter"; "Ratings"; "Rating_updater"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "lib/game_lib";
                      test_run =
                        [
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "game_lib_tests"
                        ]
                   })
            ];
     ...
     oasis_digest = Some "\200`\186\204t\209\tV\219\000#\238i1\241\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
