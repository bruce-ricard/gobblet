...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbcde1f737b20f985d395e32fab5f74c) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$lib_tests", []))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ttt_common_lib_types"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("pgocaml", None);
                           FindlibPackage ("pgocaml.syntax", None);
                           FindlibPackage ("sha", None);
                           FindlibPackage ("logs", None);
                           InternalLibrary "ttt.lib.common"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                   ...
                   {
                      lib_modules =
                        ["PostgresConfiguration"; "UsersPostgresDao"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "lib/user_lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("sha", None);
                           InternalLibrary "ttt.lib.common";
                           FindlibPackage ("glicko2", None);
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [FindlibPackage ("config-file", None)];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                      bs_interface_patterns =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "lib/server_lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt.syntax", None);
                           InternalLibrary "ttt.lib.game";
                           InternalLibrary "ttt.lib.user";
                           InternalLibrary "ttt.lib.common";
                           InternalLibrary "ttt.daos";
                           ...
                           FindlibPackage ("threads", None);
                           FindlibPackage ("glicko2", None);
                           InternalLibrary "ttt.config-file"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Base_types";
                           "Ttt_server_lib_types";
                           "Ttt_server_lib_challenge";
                           "Ttt_server_lib"
                        ];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           ...
                           "Rating_updater";
                           "Internal_types";
                           "Ttt_server_lib_games";
                           "Ttt_server_lib_game_api";
                           "Ttt_server_lib_game_list";
                           "Ttt_server_lib_game_store";
                           "Ttt_server_lib_challenge_api";
                           "Ttt_server_lib_challengeCriticalSection";
                           "List_challenge_store"
                        ];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "ttt.config-file"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                      bs_interface_patterns =
                   ...
                   {exec_custom = false; exec_main_is = "create_config.ml"});
               Executable
                 ({
                     cs_name = "lib_tests";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ttt.lib.server";
                           InternalLibrary "ttt.lib.game";
                           FindlibPackage ("alcotest", None);
                           FindlibPackage ("alcotest-lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "lib/tests";
                      test_run =
                        [
     ...
     oasis_digest = Some "\196\193>&\241\129c\243\157\214w\240]\025\206\179";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
