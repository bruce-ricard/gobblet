...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1dd53a61fcf2bbc1ae72ef9c3d4a09f1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = [];
          beta_features = [];
          name = "server configuration library";
          license_file = None;
          copyrights = [];
          maintainers = [];
          ...
          bugreports = None;
          synopsis =
            "Generates and reads configuration files for the gobblet server";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "!\129\165\000\1491\209\001>\133pp\014\199\210\206";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
